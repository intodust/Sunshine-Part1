...
public class DetailActivityFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        Log.d("DetailActivityFrag", "onCreate");
